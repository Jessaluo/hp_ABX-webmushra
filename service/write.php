...
$stimulusRating = isset($session->trials[0]->responses[0]->stimulusRating) && is_array($session->trials[0]->responses[0]->stimulusRating)
    ? $session->trials[0]->responses[0]->stimulusRating
    : array();
